...
def self_test():
    test_six_digit('./test/rar_all_alpha.rar')
    test_dict('./test/rar_all_beta.rar')
    test_six_digit('./test/zip_all_alpha.zip')
    test_single_zip_pwd('./test/zip_all_beta.zip', '"')
    test_single_zip_pwd('./test/zip_all_gamma.zip', '\' " \'')
    if 'Linux'.lower() in platform.platform().lower():
        test_single_rar_pwd('./test/rar_linux_alpha.rar', '"')
        test_single_rar_pwd('./test/rar_linux_beta.rar', '\' " \'')
        test_six_digit('./test/zip_linux_alpha.zip')
        test_single_zip_pwd('./test/zip_linux_beta.zip', '"')
        test_single_zip_pwd('./test/zip_linux_gamma.zip', '\' " \'')
